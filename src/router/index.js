...
export const constantRouterMap = [
  ...
  { path: '/401', component: () => import('@/views/errorPage/401'), hidden: true },
  {
    ...
    children: [{
      ...
      name: 'map',
      meta: { title: 'map', icon: 'dashboard', noCache: true }
    }]
  }
  // ,
  // {
...
export const asyncRouterMap = [
  ...
  // },
  {
    ...
    children: [
      { path: 'user', component: () => import('@/views/management/user'), name: 'user', meta: { title: 'user' }},
      { path: 'role', component: () => import('@/views/management/role'), name: 'role', meta: { title: 'role' }},
      { path: 'actionGroup', component: () => import('@/views/management/actionGroup'), name: 'actionGroup', meta: { title: 'actionGroup' }},
      { path: 'action', component: () => import('@/views/management/action'), name: 'action', meta: { title: 'action' }}
    ]
  },
  {
    path: '/anjian',
